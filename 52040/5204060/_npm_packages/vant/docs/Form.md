---
created: 2022-07-27T15:28:17 (UTC +08:00)
tags: []
...
用于数据录入、校验，支持输入框、单选框、复选框、文件上传等类型，需要与 [Field 输入框](https://vant-contrib.gitee.io/vant/#/zh-CN/field) 组件搭配使用。
...
在表单中，每个 [Field 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/field) 代表一个表单项，使用 Field 的 `rules` 属性定义校验规则。
...
通过 `rules` 定义表单校验规则，所有可用字段见[下方表格](https://vant-contrib.gitee.io/vant/#/zh-CN/form#rule-shu-ju-jie-gou)。
...
在表单中使用 [Switch 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/switch)。
...
在表单中使用 [Checkbox 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/checkbox)。
...
在表单中使用 [Radio 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/radio)。
...
在表单中使用 [Stepper 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/stepper)。
...
在表单中使用 [Rate 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/rate)。
...
在表单中使用 [Slider 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/slider)。
...
在表单中使用 [Uploader 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/uploader)。
...
在表单中使用 [Picker 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/picker)。
...
在表单中使用 [DatetimePicker 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/datetime-picker)。
...
在表单中使用 [Area 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/area)。
...
在表单中使用 [Calendar 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/calendar)。
...
> 表单项的 API 参见：[Field 组件](https://vant-contrib.gitee.io/vant/#/zh-CN/field#api)
...
通过 ref 可以获取到 Form 实例并调用实例方法，详见[组件实例方法](https://vant-contrib.gitee.io/vant/#/zh-CN/advanced-usage#zu-jian-shi-li-fang-fa)。
...
Vant 支持在 Form 组件中插入自定义的表单项，具体用法参见 [useCustomFieldValue](https://vant-contrib.gitee.io/vant/#/zh-CN/use-custom-field-value)。
