---
created: 2022-07-27T15:28:28 (UTC +08:00)
tags: []
source: https://vant-contrib.gitee.io/vant/#/zh-CN/button
author: 
---

# PasswordInput 密码输入框 - Vant 3
...
带网格的输入框组件，可以用于输入密码、短信验证码等场景，通常与[数字键盘](https://vant-contrib.gitee.io/vant/#/zh-CN/number-keyboard)组件配合使用。
