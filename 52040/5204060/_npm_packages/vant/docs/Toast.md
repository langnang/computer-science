---
created: 2022-07-27T15:27:40 (UTC +08:00)
tags: []
...
通过 `icon` 选项可以自定义图标，支持传入图标名称或图片链接，等同于 Icon 组件的 [name 属性](https://vant-contrib.gitee.io/vant/#/zh-CN/icon#props)。
...
| message | 文本内容，支持通过`\n`换行 | _string_ | `''` |
| icon | 自定义图标，支持传入图标名称或图片链接，等同于 Icon 组件的 [name 属性](https://vant-contrib.gitee.io/vant/#/zh-CN/icon#props) | _string_ | \- |
| iconSize | 图标大小，如 `20px` `2em`，默认单位为 `px` | _number | string_ | `36px` |
| iconPrefix | 图标类名前缀，等同于 Icon 组件的 [class-prefix 属性](https://vant-contrib.gitee.io/vant/#/zh-CN/icon#props) | _string_ | `van-icon` |
...
| loadingType | [加载图标类型](https://vant-contrib.gitee.io/vant/#/zh-CN/loading), 可选值为 `spinner` | _string_ | `circular` |
