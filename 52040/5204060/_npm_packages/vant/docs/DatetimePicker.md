---
created: 2022-07-27T15:28:05 (UTC +08:00)
tags: []
source: https://vant-contrib.gitee.io/vant/#/zh-CN/button
author: 
---

# DatetimePicker 时间选择 - Vant 3
...
时间选择器，支持日期、年月、时分等维度，通常与[弹出层](https://vant-contrib.gitee.io/vant/#/zh-CN/popup)组件配合使用。
...
| 参数 | 说明 | 类型 | 默认值 |
| --- | --- | --- | --- |
| type | 时间类型，可选值为 `date` `time`  
`year-month` `month-day` `datehour` | _string_ | `datetime` |
...
通过 ref 可以获取到 DatetimePicker 实例并调用实例方法，详见[组件实例方法](https://vant-contrib.gitee.io/vant/#/zh-CN/advanced-usage#zu-jian-shi-li-fang-fa)。

| 方法名 | 说明 | 参数 | 返回值 |
| --- | --- | --- | --- |
| getPicker | 获取 Picker 实例，用于调用 Picker 的[实例方法](https://vant-contrib.gitee.io/vant/#/zh-CN/picker#fang-fa) | \- | \- |
