---
created: 2022-07-27T15:30:30 (UTC +08:00)
tags: []
source: https://vant-contrib.gitee.io/vant/#/zh-CN/button
author: 
---

# Collapse 折叠面板 - Vant 3
...
| 参数 | 说明 | 类型 | 默认值 |
| --- | --- | --- | --- |
| v-model | 当前展开面板的 name | 手风琴模式：_number | string_  
非手风琴模式：_(number | string)\[\]_ | \- |
...
| icon | 标题栏左侧图标名称或图片链接，等同于 Icon 组件的 [name 属性](https://vant-contrib.gitee.io/vant/#/zh-CN/icon#props) | _string_ | \- |
...
通过 ref 可以获取到 CollapseItem 实例并调用实例方法，详见[组件实例方法](https://vant-contrib.gitee.io/vant/#/zh-CN/advanced-usage#zu-jian-shi-li-fang-fa)。
